...
export default function About({
  ...
  return (
    ...
    >
      ...
      {/* IRIDESCENT */}
      <div className="pointer-events-none absolute left-[-180px] top-[20%] h-[500px] w-[500px] rounded-full bg-gradient-to-br from-cyan-400/10 via-purple-500/10 to-pink-400/10 blur-3xl" />
        ...
        <div className="grid gap-6 lg:grid-cols-[390px_1fr]">
          ...
          <Reveal delay={0.12}>
            <motion.div
              ...
              className="group relative min-h-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#0a0a0a] p-7 md:p-10"
            >
              <div className="pointer-events-none absolute inset-0 tech-grid-dark opacity-20" />

              <div className="pointer-events-none absolute -right-24 -top-24 h-80 w-80 rounded-full bg-gradient-to-br from-cyan-300/10 via-purple-400/15 to-pink-300/10 blur-3xl transition duration-700 group-hover:scale-125" />
              ...
              <div className="relative">
                ...
                {/* INFO */}
                <div className="  grid grid-cols-1 gap-7 border-t border-white/10 pt-7 sm:grid-cols-3 sm:gap-5">
                  <div>
                    <span className="micro-text-light">
                      BIRTHDAY
                    </span>
